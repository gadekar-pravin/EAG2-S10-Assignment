...
class QueryHeuristics:
    """
    Provides a set of heuristic checks for validating and sanitizing queries.
    ...
    def __init__(self):
        """
        Initialize the QueryHeuristics with default blacklist and rules.
        """
    ...
    def _extract_urls_from_text(self, text: str) -> List[Tuple[str, str]]:
        ...
        Returns:
            List[Tuple[str, str]]: list of (original_url, processed_url) tuples
        """
    ...
    def _check_url(self, query: str) -> Tuple[bool, str]:
        ...
        Args:
            query (str): The query containing potential URLs.
    ...
    def _check_file_path(self, query: str) -> Tuple[bool, str]:
        ...
        Args:
            query (str): The query containing potential file paths.
    ...
    def process(self, query: str) -> Tuple[bool, str, str]:
        ...
        Returns:
            Tuple[bool, str, str]: (passed_all, message, sanitized_query)
        """
    ...
    def add_rule(self, name: str, rule_func: Callable[[str], Tuple[bool, str]]):
        ...
        Args:
            ...
            rule_func (Callable[[str], Tuple[bool, str]]): The function implementing the rule.
        """
